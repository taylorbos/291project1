...
insert into tweets values (4,3,'03-DEC-2016','A big thanks to all the wonderful TAs #UoA #edmonton',null);
insert into tweets values (5,4,'19-MAR-2016','Shoutout to all the average joes out there!',null);
insert into tweets values (6,4,'30-JAN-2016','Super confused about the music video for Taylors new song #taylorswift',null);
...
insert into tweets values (9,6,'29-NOV-2016','Is anyone else in #edmonton super excited for Jim Wu #jimismoving',null);
...
insert into tweets values (12,14,'04-SEP-2016','Water And Alcohol Are Pretty Much The Same. #juvenilephilosophy',null);
insert into tweets values (13,14,'20-NOV-2016','If Newborn Babies Could Speak They Would Be Smart #juvenilephilosophy',null);
...
insert into tweets values (19,29,'15-FEB-2016','Roses are red, I love my wife, this was a mistake #rosesarered',null);
insert into tweets values (20,29,'13-JUL-2016','Roses are red, rice is plain, vote for me again #america #rosesarered',19);
insert into tweets values (21,29,'16-DEC-2016','#America, this isnt what we meant when we said orange is the new black..',null);
insert into tweets values (22,41,'13-JUL-2016','Roses are red, deers eat flowers, creating this took 10 hours #rosesarered',19);
insert into tweets values (23,67,'29-JAN-2016','The music video for Bad Blood is out now! #taylorswift',null);
insert into tweets values (24,67,'18-NOV-2014','Were breaking up? Guess Ill make another million bucks! #taylorswift',17);
insert into tweets values (25,77,'14-FEB-2016','Roses are red, chocolates are brown, Im always let down #rosesarered',20);
insert into tweets values (26,83,'14-FEB-2014','Tell me Im your national treasure',null);
insert into tweets values (27,83,'16-DEC-2016','The government is shut down, Im gonna steal the declaration of independence',null);
...
insert into hashtags values ('jimsmoving');
...
insert into mentions values (1, 'rosesrred');
...
insert into mentions values (6, 'tswift');
...
insert into mentions values (9, 'jimsmoving');
insert into mentions values (10, 'philosophy');
insert into mentions values (11, 'philosophy');
insert into mentions values (12, 'philosophy');
insert into mentions values (13, 'philosophy');
insert into mentions values (14, 'philosophy');
insert into mentions values (15, 'edmonton');
insert into mentions values (16, 'edmonton');
insert into mentions values (18, 'jimsmoving');
insert into mentions values (19, 'rosesrred');
insert into mentions values (20, 'america');
insert into mentions values (20, 'rosesrred');
insert into mentions values (21, 'america');
insert into mentions values (22, 'rosesrred');
insert into mentions values (23, 'tswift');
insert into mentions values (24, 'tswift');
insert into mentions values (25, 'rosesrred');
...
insert into retweets values (15,11,'28-MAY-2016');
insert into retweets values (15,12,'04-SEP-2016');
insert into retweets values (15,13,'20-NOV-2016');
